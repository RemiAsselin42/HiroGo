...
const markersData = [
    ...
    { color: '#3b2ca9', coordinates: [4.456, 44.854], title: 'Information utilisateur', description: 'Café sympa pour une pause' },
    ...
    { color: '#ffd518', coordinates: [4.585, 43.514], title: 'Alerte attention', description: 'Travaux en cours' },
